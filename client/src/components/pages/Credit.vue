<template>
  <b-container id="credit" fluid @showAlert="showAlert">
    <h2>THE TEAM</h2>
    <hr />
    <div class="content">
    ...
    <!-- <div class="content">
      <StaffCreditComponent
        ...
        user="xRexy"
        skills="none lol"
        user_desc="Even less than Sayykii"
        copy_data="xrexy#3616"
        :image_url="require('@/assets/personal/xrexy.png')"
        @showAlert="showAlert"
      />
      <StaffCreditComponent
        ...
        job_class="Designer"
        user="Xylia"
        user_desc="User Interface Designer"
        copy_data="X឵#3301"
        :image_url="require('@/assets/personal/xylia.png')"
        @showAlert="showAlert"
      />
...
#credit {
  ...
  height: 100%;
  width: 100%;
  background: url(../../assets/backgrounds/homepage-1.png) fixed center repeat;
